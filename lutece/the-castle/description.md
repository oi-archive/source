...
By way of example, this castle sits on a $7\times 4$ base. A `room` includes any set of connected `squares` in the floor plan. This floorplan contains five rooms (whose sizes are $9$, $7$, $3$, $1$, and $8$ in no particular order).
...
Line $2\cdots $: $M\times N$ integers, several per line.
