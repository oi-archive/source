...
![polygon1.png](/source/guoj/1305/img/aHR0cHM6Ly9sb2otaW1nLnVweXVuLm1lbmNpLm1lbXNldDAuY24vMjAxOS8wNy8wMS81ZDE5OTMyNjczMzkxLnBuZw==.png)
...
![polygon2.png](/source/guoj/1305/img/aHR0cHM6Ly9sb2otaW1nLnVweXVuLm1lbmNpLm1lbXNldDAuY24vMjAxOS8wNy8wMS81ZDE5OTMzYjkxMWZlLnBuZw==.png)
...
#### 样例 2
见附加文件中的 `polygon2.in` 与 `polygon2.ans`。

#### 样例 3
见附加文件中的 `polygon3.in` 与 `polygon3.ans`。

#### 样例 4
见附加文件中的 `polygon4.in` 与 `polygon4.ans`。
...
| :--: | :--------: | :-----: | :------: | :--: | :--------: | :-----: | :------: |
| $1$  |  $\le 5$   | $\le 3$ |    无    | $11$ | $\le 10^3$ | $\le 2$ |    A     |
| $2$  |  $\le 10$  | $\le 3$ |    无    | $12$ | $\le 10^3$ | $\le 2$ |    A     |
| $3$  |  $\le 15$  | $\le 3$ |    无    | $13$ | $\le 10^3$ | $\le 2$ |    A     |
| $4$  |  $\le 20$  | $\le 3$ |    无    | $14$ | $\le 10^3$ | $\le 2$ |    无    |
| $5$  | $\le 10^3$ |  $=1$   |    A     | $15$ | $\le 10^3$ | $\le 2$ |    无    |
| $6$  | $\le 10^3$ |  $=1$   |    A     | $16$ | $\le 10^3$ | $\le 2$ |    无    |
| $7$  | $\le 10^3$ |  $=1$   |    A     | $17$ | $\le 10^3$ | $\le 3$ |    A     |
| $8$  | $\le 10^3$ |  $=1$   |    无    | $18$ | $\le 10^3$ | $\le 3$ |    A     |
| $9$  | $\le 10^3$ |  $=1$   |    无    | $19$ | $\le 10^3$ | $\le 3$ |    无    |
| $10$ | $\le 10^3$ |  $=1$   |    无    | $20$ | $\le 10^3$ | $\le 3$ |    无    |

其中性质 A 为保证树上所有节点至多有两个孩子。

对于所有的数据，保证 $1 \le f_i \le i, 2 \le n \le 10^3$。

保证 $K\ge 1$。

提示：DFS 序是从 $1$ 号点开始对整棵树进行深度优先遍历时被访问节点按照从先到后的顺序形成的序列。
