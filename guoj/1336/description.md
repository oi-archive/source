...
![tree](/source/guoj/1336/img/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMTEvMTkvcEI4WHFNRVFnVUNqaDl5LnBuZw==.png)

如上图，蓝圈中的数字 $1 \sim 5$ 一开始分别在结点②、①、③、⑤、④。按照 (1)(4)(3)(2) 的顺序删去所有边，树变为下图。按数字顺序得到的结点编号排列为①③④②⑤，该排列是所有可能的结果中字典序最小的。

![tree](/source/guoj/1336/img/aHR0cHM6Ly9pLmxvbGkubmV0LzIwMTkvMTEvMTkveFYxbmdZaDRFTEEzOURGLnBuZw==.png)
