...
<div class="content">一架人类的航天飞机将人类基地建在了一个荒芜的星球上。面对紧缺的能源，他们只能在最短的时间内用SCV（一种智能机器人）采集必须的矿藏。对于这个艰巨的任务，他们希望得到编程高手们的帮助。
...
<div class="content">输入文件只有一行，依次为t1,t2,t3,p1,p2，每两个数字之间有一个空格。其中1&lt;=t1,t2,t3&lt;=100,0&lt;=p1,p2&lt;=10000
</div>

# Output

<div class="content">输出文件只包含一个数字，表示可以达到目标的最少时间。

</div>

# Sample Input

<div class="content"><span class="sampledata">10 9 18 150 0<br/>
<br/>
</span></div>
