...
<div class="content"><p><span style="font-size: medium">给定一张包含N个单词的表，每个单词有个价值W。要求从中选出一个子序列使得其<br/>
...
<div class="content"><p><font size="4">第一行一个整数TEST，表示数据组数。 <br/>
接下来TEST组数据，每组数据第一行为一个整数N。 <br/>
接下来N行，每行为一个字符串和一个整数W。 <br/>
</font></p></div>

# Output

<div class="content"><p><font size="4">TEST行，每行一个整数，表示W的和的最大值。 <br/>
 <br/>
 <br/>
数据规模 <br/>
设字符串的总长度为Len <br/>
30.的数据满足，TEST≤5，N≤500，Len≤10^4 <br/>
100.的数据满足，TEST≤10，N≤20000，Len≤3*10^5 </font></p></div>
...
aabbbbabbbbaaaababbbbbabaaaabbaaababaababaaaaaabaaabaabbbbbbbabbabbbabbabaaaabaabbbbabbbbbbbbaaaaabababbbabbaaababbaaaaababbbabbababaaaab 535<br/>
abbabaaaabaabaabbaabbaaabababbbbaabbbbbaabaababbbbbbaaaaababbbaaabaaaaaabbabaabbaaaabbbabababbbabaabbabbabababbababaaaabbabbabbbbababbabaaaaababbaabaabbbabab 565<br/>
bbabb -685<br/>
ba 279<br/>
aa 214<br/>
a -912<br/>
...
<div class="content"><span class="sampledata">63212<br/>
</span></div>
