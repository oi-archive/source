...
<div class="content">WJJ喜欢“魔兽争霸”这个游戏。在游戏中，巫妖是一种强大的英雄，它的技能Frozen Nova每次可以杀死一个小精灵。我们认为，巫妖和小精灵都可以看成是平面上的点。
...
<div class="content">输入文件第一行包含三个整数N、M、K(N,M,K&lt;=200)，分别代表巫妖的数量、小精灵的数量和树木的数量。
...
<div class="content">输出一行，为消灭所有小精灵的最短时间（以秒计算）。如果永远无法消灭所有的小精灵，则输出-1。
