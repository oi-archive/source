...
<div class="content"><p><img height="286" width="829" alt="" src="source/bzoj/1580/img/aHR0cHM6Ly9seWRzeS5jb20vSnVkZ2VPbmxpbmUvdXBsb2FkLzIwMTQwMS8yMigxNykuanBn.jpg"/></p></div>
...
<p class="MsoNormal" style="margin: 0cm 0cm 0pt"><font size="3"><span lang="EN-US"><font face="Times New Roman">    </font></span><span style="font-family: 宋体; mso-ascii-font-family: &#39;Times New Roman&#39;; mso-hansi-font-family: &#39;Times New Roman&#39;">一个整数，表示在逃脱过程中，某一个时刻最多有这个数理的杀手可以射杀贝茜．</span></font></p></div>

# Sample Input

<div class="content"><span class="sampledata">3 1 0 0 0 2<br/>
0 -3 0 4<br/>
1 2 -1 1<br/>
1 -2 2 -1</span></div>
...
OUTPUT DETAILS:<br/>
<br/>
At time 1.5, Bessie is at point (0, 3), and the three bruisers are<br/>
at points (0, 3), (-0.5, 3.5), and (4, -3.5). The first two cattle<br/>
bruisers are within 1 unit of Bessie, while the third will never<br/>
be within 1 unit of Bessie, so 2 is the most achievable.</span></div>
