...
<div class="content">输入文件中第一行有一个整数N，表示这个星球上某种生物使用了N种不同的碱基，以后将它们编号为1…N的整数。
以下还有两行，每行描述一个DNA序列：包含5N个1…N的整数，且每一个整数在对应的序列中正好出现5次。
</div>

# Output

<div class="content">输出文件中只有一个整数，即两个DNA序列的最大匹配数目。
</div>

# Sample Input

<div class="content"><span class="sampledata">2<br/>
1 1 2 2 1 1 2 1 2 2<br/>
1 2 2 2 1 1 2 2 1 1<br/>
</span></div>
...
<div class="content"><p>[数据约束和评分方法]<br/>
60%的测试数据中：1&lt;=N &lt;= 1 000<br/>
100%的测试数据中：1&lt;=N &lt;= 20 000<br/>
</p></div>
