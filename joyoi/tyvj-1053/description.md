...
输出文件expand.out只有一行，为展开后的字符串。 
 ...
 # 提示 
&nbsp;&nbsp;&nbsp;&nbsp;40%的数据满足：字符串长度不超过5<BR>&nbsp;&nbsp;&nbsp;&nbsp;100%的数据满足：1&lt;=p1&lt;=3,&nbsp;1&lt;=p2&lt;=8,&nbsp;1&lt;=p3&lt;=2。字符串长度不超过100<BR> 
# 样例数据
<style>
