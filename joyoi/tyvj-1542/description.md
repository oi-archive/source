...
包含两行，每行包含一个整数。第一行为可以找到的最大正方形棋盘的面积，第二行为可以找到的最大矩形棋盘的面积（注意正方形和矩形是可以相交或者包含的）。 
 ...
 # 提示 
对于20%的数据，N,&nbsp;M&nbsp;≤&nbsp;80<BR>对于40%的数据，N,&nbsp;M&nbsp;≤&nbsp;400&nbsp;<BR>对于100%的数据，N,&nbsp;M&nbsp;≤&nbsp;2000<BR><BR>2007年浙江省省选第一试 
# 样例数据
<style>
