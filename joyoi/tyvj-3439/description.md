...
　　输出文件escape.out包括m行，即对于每一个出口，问从起始点到出口的最小代价为多少，若不能到达则输出-1。</p> 
 ...
 # 提示 
<p>
【样例说明】<br>　　如下图所示<br><br><center><img src="/source/joyoi/tyvj-3439/img/aHR0cDovL3d3dy5qb3lvaS5jbi9wcm9ibGVtL3R5dmotMzQzOS9wcm9ibGVtc19pbWFnZXMvMjI0NS8xLmpwZw==.jpg"></img></center><br><br>【数据规模】<br>　　对于20%的数据，n≤10，m≤10，所有坐标涉及的正整数不大于10；<br>　　对于40%的数据，所有坐标涉及的正整数不大于300；<br>　　对于50%的数据，n≤1000，m≤10；<br>　　对于70%的数据，所有坐标涉及的正整数不大于1000；<br>　　对于100%的数据，n≤100000，m≤100000，所有坐标涉及的正整数不大于10^8。<br></p> 
# 样例数据
<style>
