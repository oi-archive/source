...
**注意，这个 `simulator` 来自现场赛，仅保证在 Ubuntu 14.04/NOI Linux 1.4.1 和 Ubuntu 16.04 下能够运行。其它系统如果无法运行，请自行下载测试数据中的 `spj_cpp11.cpp` 编译进行测试，不过此程序为 LOJ 的 Special Judge，与 `simulator` 用法差别较大，Special Judge 的具体用法详见本站帮助。**
